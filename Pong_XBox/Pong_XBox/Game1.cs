...
namespace Pong
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Initialize()
        {
            ...
            Resolution.SetVirtualResolution(1280, 720); // This value may never change from here on anymore! Use SetResolution instead.
            Resolution.SetResolution(1280, 720, true);

            // Audio
            Engine.Audio.Lookup.Add("hitBoundary", "4359__NoiseCollector__PongBlipF4");
            Engine.Audio.Lookup.Add("hitBar", "4365__NoiseCollector__pongblipA5");
            Engine.Audio.Lookup.Add("cheer", "35964__johansyd__cheer");
            Engine.Audio.Lookup.Add("mainMenuMusic", "29589__ERH__angels");
