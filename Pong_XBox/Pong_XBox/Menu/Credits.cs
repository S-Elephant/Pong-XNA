...
namespace Pong
{
    ...
    public class Credits : IActiveState
    {
        ...
        public Credits(IActiveState parent)
        {
            ...
            AllCredits.Add(new Credit(true, "Pong"));
            AllCredits.Add(new Credit(true, "Created on 1 December 2010 in a single day"));
            AllCredits.Add(new Credit(true, ""));
            AllCredits.Add(new Credit(true, ""));
            AllCredits.Add(new Credit(true, "Programming & Design"));
            AllCredits.Add(new Credit(false, "Carlo von Ranzow"));
            AllCredits.Add(new Credit(true, ""));
            AllCredits.Add(new Credit(true, "Audio"));
            AllCredits.Add(new Credit(false, "(All audio recordings where taken from http://www.freesound.org)"));
            AllCredits.Add(new Credit(false, "johansyd - goal sound"));
            AllCredits.Add(new Credit(false, "NoiseCollector - For the 'ball-bump' sounds"));
            AllCredits.Add(new Credit(false, "ERH - Main menu music"));
            AllCredits.Add(new Credit(true, ""));
            AllCredits.Add(new Credit(true, "Graphics"));
            AllCredits.Add(new Credit(false, "Carlo von Ranzow (for the simple graphics and editing)"));
            AllCredits.Add(new Credit(false, "http://www.lostgarden.com (ball sprite)"));
            AllCredits.Add(new Credit(true, ""));
            AllCredits.Add(new Credit(true, "Misc"));
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if (GPInput.IsButtonPressed(Buttons.B))
            {
                Engine.Instance.ActiveState = Parent;
            }
        }
